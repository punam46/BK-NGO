...
const Admin = () => {
  ...
  const [modalType, setModalType] = useState(''); // 'photo', 'cert', 'pub'
            ...
            <form onSubmit={handleAddData} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
              {modalType === 'photo' && (
                <>
                  ...
                  <input type="text" placeholder="Category (e.g. EVENTS)" onChange={(e) => setFormData({...formData, category: e.target.value})} style={{ padding: '1rem', borderRadius: '12px', border: '1px solid #ddd' }} required />
                </>
              )}
              {modalType === 'cert' && (
                <>
                  ...
                  <input type="text" placeholder="Subtitle (e.g. REGISTRATION CERTIFICATE)" defaultValue={formData.subtitle} onChange={(e) => setFormData({...formData, subtitle: e.target.value})} style={{ padding: '1rem', borderRadius: '12px', border: '1px solid #ddd' }} required />
                  <input type="text" placeholder="Certification Title" defaultValue={formData.title} onChange={(e) => setFormData({...formData, title: e.target.value})} style={{ padding: '1rem', borderRadius: '12px', border: '1px solid #ddd' }} required />
                  <input type="text" placeholder="Organization" defaultValue={formData.organization} onChange={(e) => setFormData({...formData, organization: e.target.value})} style={{ padding: '1rem', borderRadius: '12px', border: '1px solid #ddd' }} required />
                  <input type="text" placeholder="ID Number" defaultValue={formData.idNumber} onChange={(e) => setFormData({...formData, idNumber: e.target.value})} style={{ padding: '1rem', borderRadius: '12px', border: '1px solid #ddd' }} required />
                  <textarea placeholder="Description" defaultValue={formData.description} onChange={(e) => setFormData({...formData, description: e.target.value})} style={{ padding: '1rem', borderRadius: '12px', border: '1px solid #ddd', minHeight: '80px' }} required />
                </>
              )}
              {modalType === 'pub' && (
                <>
              ...
              {modalType === 'program' && (
                <>
                  <input type="text" placeholder="Program Title" defaultValue={formData.title} onChange={(e) => setFormData({...formData, title: e.target.value})} style={{ padding: '1rem', borderRadius: '12px', border: '1px solid #ddd' }} required />
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                  ...
                  <input type="text" placeholder="Category (e.g. Welfare)" defaultValue={formData.category} onChange={(e) => setFormData({...formData, category: e.target.value})} style={{ padding: '1rem', borderRadius: '12px', border: '1px solid #ddd' }} />
                  <textarea placeholder="Full Description" defaultValue={formData.description} onChange={(e) => setFormData({...formData, description: e.target.value})} style={{ padding: '1rem', borderRadius: '12px', border: '1px solid #ddd', minHeight: '120px' }} required />
                </>
              )}
